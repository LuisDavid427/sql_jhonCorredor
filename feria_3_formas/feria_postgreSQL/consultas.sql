...
select * from feria as f inner join pabellon as p on f.id_feria = p.id_feria;

select * from tematica as t inner join pabellon as p on t.id_tematica = p.id_tematica;
